...
contract DSCEngine is ReentrancyGuard {
    ...
    uint256 private constant LIQUIDATTION_BONUS = 10 //this means a 10% bonus
    ...
    event CollateralRedeemed(address indexed redeemdeFrom, address redeemedTo, address indexed token, uint256 amount);
    ...
    */
        ...
        external
    {
        ...
        //redeeem collateral already check healthfactor
    }
    ...
    */
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // this might not hit
    }
     ...
     *@param user The user who broken the hea;th factor. Their _healthfactor should be below MIN_HEALTH_FACTOR
     *@param debtToCover The amount of DSC to burn to improve the users health factor
     *@notice You cna partially liquidate a user. 
     *@notice you will get a liqidation bonus for taking the users funds
     ...
     * For example, if the price of the collateral plummeted before anyone be liquidated.
     * 
     * Follows: CEI
     */
        ...
        nonReentrant
    {
        ...
        // we should implement a fature to liquidate in the event the protocol is insolvent
        // And sweep extra amounts into a trasury
    ...
    /*
    * @dec low-level internal function, do not call unless yhe function calling it is
    ...
    */
    ...
    function getTokenAmountFromUsd(address token, uint256 usdAmountInWei) public view returns (uint256) {
        ...
        //1 ETH = $1000
        //the returned value from CL will be 1
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        return ((uint256(price) * ADDITIONAL_FEED_PRECISION) * amount) / PRECISION; // (1000 * 1e8) * 1000 * 1e8
    }
}
