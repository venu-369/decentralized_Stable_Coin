...
contract DSCEngine is ReentrancyGuard {
    ...
    */
    ...
    function _getAccountInformation(address user) private view returns(uint256 totalDscMinted, uint256 collateralValueInUsd) {
        ...
        //1. Get all the collateral they have
        //2. Get the value of all the collateral
        //3. Get the total DSC minted
        //4. Get the value of all the DSC minted
        //5. Return the total DSC minted and total collateral value
    ...
    */
    ...
    function getUsdValue(address token, uint256 amount) public view returns(uint256) {
        ...
        return price * amount; // (1000 * 1e8) * 1000 * 1e8
    }
}
